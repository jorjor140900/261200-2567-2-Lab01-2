...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] a) {
        ...
        bob.up();
        bob.setPosition(-228, -12);
        bob.down();
        bob.face(0, -11);
        bob.forward(50);

        bob.up();
        bob.setPosition(-71, -176);
        bob.down();
        bob.face(-190, 60);
        bob.forward(80);
        ...
        //T
        bob.up();
        bob.setPosition(-120, -8);
        bob.down();
        bob.face(0, -8);
        bob.forward(300);

        bob.up();
        bob.setPosition(-80, -40);
        bob.down();
        bob.face(0, -40);
        bob.forward(90);

        bob.up();
        bob.setPosition(140, -40);
        bob.down();
        bob.face(0, -40);
        bob.forward(90);
        ...
        bob.up();
        bob.setPosition(180, -8);
        bob.down();
        bob.face(0, -150);
        bob.forward(52);

        bob.up();
        bob.setPosition(10, -40);
        bob.down();
        bob.face(27, -150);
        bob.forward(110);

        bob.up();
        bob.setPosition(50, -40);
        bob.down();
        bob.face(27, -150);
        bob.forward(110);
        ...
        //E
        bob.up();
        bob.setPosition(315, -12);
        bob.down();
        bob.face(0, -12);
        bob.forward(80);

        bob.up();
        bob.setPosition(235, -12);
        bob.down();
        bob.face(20, -146);
        bob.forward(106);

        bob.up();
        bob.setPosition(145, -68);
        bob.down();
        bob.face(0, -330);
        bob.forward(30);

        bob.up();
        bob.setPosition(130, -95);
        bob.down();
        bob.face(220, -63);
        bob.forward(50);

        bob.up();
        bob.setPosition(90, -159);
        bob.down();
        bob.face(320, 330);
        for (int i = 0; i < 45; i++) {
            bob.forward(2.7);
        ...
        bob.up();
        bob.setPosition(137, -146);
        bob.down();
        bob.face(300, -180);
        bob.forward(150);

        bob.up();
        bob.setPosition(285, -176);
        bob.down();
        bob.face(320, 90);
        for (int i = 0; i < 70; i++) {
            bob.forward(1.4);
